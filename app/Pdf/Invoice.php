...
class Invoice
{
    public static function render($invoice, $lineItems, $customer)
    {
        ...
        $pdf = new \LaminasPdf\PdfDocument();

        $pdf->pages[] = $pdf->newPage(\LaminasPdf\Page::SIZE_LETTER);
        ...
        $c = array(); //colors
        $c["fill"]  = new \LaminasPdf\Color\GrayScale(0.8);
        $c["dark"]  = new \LaminasPdf\Color\GrayScale(0.0);
        $c["lite"]  = new \LaminasPdf\Color\GrayScale(0.5);
        $c["white"] = new \LaminasPdf\Color\GrayScale(1.0);
        $c["odd"]   = new \LaminasPdf\Color\Html("#ffffff");
        $c["even"]  = new \LaminasPdf\Color\Html("#f0f0f0");
        $c["blue"]  = new \LaminasPdf\Color\Html("#ddeeff");

        $nFont = \LaminasPdf\Font::fontWithName(\LaminasPdf\Font::FONT_HELVETICA);
        $bFont = \LaminasPdf\Font::fontWithName(\LaminasPdf\Font::FONT_HELVETICA_BOLD);
        $fontSize = 8;
        ...
        $page->drawRectangle($x1 - 1, $y1 + 1, $x1 + $radius, $y1 - $radius, \LaminasPdf\Page::SHAPE_DRAW_FILL);
        $page->drawRectangle($x1 - 1, $y2 + $radius, $x1 + $radius, $y2 - 1, \LaminasPdf\Page::SHAPE_DRAW_FILL);
        $page->drawRectangle($x2 - $radius, $y1 + 1, $x2 + 1, $y1 - $radius, \LaminasPdf\Page::SHAPE_DRAW_FILL);
        $page->drawRectangle($x2 - $radius, $y2 + $radius, $x2 + 1, $y2 - 1, \LaminasPdf\Page::SHAPE_DRAW_FILL);
        ...
        foreach ( $lineItems as $line )
        {
            ...
            $page->drawRectangle(72, $y - 4, 540, ($y - $lineHeight) - 4, \LaminasPdf\Page::SHAPE_DRAW_FILL);
            $page->setFillColor($c["dark"]);
